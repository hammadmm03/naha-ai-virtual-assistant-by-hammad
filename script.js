...
window.onload = function () {
  ...
  alert("⚠️ This works best on Chrome.\n\n👉 Please click on NAHA (the robot) once to start voice recognition.");
  speechSynthesis.cancel();
  if (robo) {
    robo.addEventListener("click", function initAudio() {
      console.log("✅ User clicked NAHA - Audio/Voice recognition can now start.");
